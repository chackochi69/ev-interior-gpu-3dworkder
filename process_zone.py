...
def run_colmap_pipeline(work_dir: str, img_dir: str) -> str:
    ...
    # Only find one model — multiple_models=True (default) exhaustively tries
    # every image pair as a starting point, which is O(n²) expensive on small
    # image sets with relaxed thresholds. Stopping after the first complete
    # model keeps runtime predictable.
