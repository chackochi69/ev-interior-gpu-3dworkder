...
def run_colmap_pipeline(work_dir: str, img_dir: str) -> str:
    ...
    # extract_features() expects FeatureExtractionOptions (not SiftExtractionOptions).
    # The 'device' kwarg forces CPU SIFT regardless of COLMAP_USE_GPU env var,
    # because pycolmap bundles its own binary which may not have GPU SIFT available.
    _feat_opts = pycolmap.FeatureExtractionOptions()
    try:
        _feat_opts.max_num_features = 8192
    ...
    # Always CPU — pycolmap wheel does not include GPU matching.
